...
echo "<script>alert('Registration successful. You can now donate blood in Yaoundé.');</script>";
}
else
{
 ...
 <div class="login px-4 mx-auto mw-100">
                            ...
                            <form action="#" method="post"  name="signup" onsubmit="return checkpass();">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="mobileno" required placeholder="e.g 6XXXXXXXX" maxlength="9" pattern="6[0-9]{8}">
                                </div>
...
<option value="">Select Area (Yaoundé)</option>
<option>Bastos</option>
<option>Mvan</option>
<option>Emana</option>
<option>Ekounou</option>
<option>Essos</option>
<option>Obili</option>
<option>Ngousso</option>
