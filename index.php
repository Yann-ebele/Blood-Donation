...
<body>
	...
	<div class="banner-bottom py-5">
		<div class="d-flex container py-xl-3 py-lg-3">
			...
			<h3 class="text-white my-3">Hospitals and Blood Donors in Yaoundé</h3>
<p>This platform connects hospitals, blood banks, and voluntary blood donors within Yaoundé to help patients receive blood quickly during emergencies.</p>
			</div>
			<div class="button">
	...
	<div class="blog-w3ls py-5" id="blog">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title text-white">Blood Donors Availsble</h3>
				<span>
	...
	<div class="screen-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">Blood donors registered can belong to any of the following blood groups.</p>
			</div>
			<div class="row">
            <div class="col-lg-6">
...
Type O individuals are often called "universal donors" since their blood can be transfused into persons with any blood type. Those with type AB blood are called "universal recipients" because they can receive blood of any type.</p>
            ...
            <div class="col-md-4" style="padding-top: 30px;"> 
                ...
                <a class="btn btn-lg btn-secondary btn-block login-button ml-lg-5 mt-lg-0 mt-4 mb-lg-0 mb-3" data-toggle="modal" data-target="#exampleModalCenter1" href="donor-list.php" data-toggle="modal" data-target="#exampleModalCenter1"> Become a Donor</a>
            </div>
        </div>
		</div>
	</div>
